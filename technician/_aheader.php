				...
				<nav class="navbar-top" role="navigation">
					...
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index2.php">
								<?php echo Login::getFullNameFront($techInSessionId, $type="tech");?>
							</a>
						</div>
					</div>
					<!-- END BRAND HEADING -->
							...
							<ul class="nav navbar-right">
								...
								<li class="dropdown user-box">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">
										<img class="img-circle" src="" alt="User Images" width="32px" height="32px"> <span class="user-info"><?php echo Login::getFullNameFront($techInSessionId, $type="technician");?></span> <b class="caret"></b>
									</a>
