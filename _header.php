...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Computer Servicing Helpdesk dashboard</title>
							...
							<ul class="nav navbar-right">
								...
								<li class="dropdown user-box">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">
										<img class="img-circle" src="<?php echo "account/" . $userInSessionId . ".jpg"; ?>" alt="User Images" width="32px" height="32px"> <span class="user-info"><?php echo Login::getFullNameFront($userInSessionId, $type='customer');?></span> <b class="caret"></b>
									</a>
