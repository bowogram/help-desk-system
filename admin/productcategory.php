...
if($objForm->isPost('buttonUpdate')){
	...
	if($objValid->chkiferrempty()){
		if($objPro->updateProduct($id, $category, $description)){
			Helper::redirect('productcategory.php');
		}else{
...
if($objForm->isPost('buttonCreate')){
	...
	if($objValid->chkiferrempty()){
		if($objPro->addProduct($category, $description)){
			Helper::redirect('productcategory.php');
		}else{
			Helper::redirect('error.php');
		}
												...
												<div class="portlet-body">
													...
													<div class="col-sm-12">
														...
														<?php echo $objValid->validate('product'); ?>
															...
															<input type="text" class="form-control"  name="category" placeholder="product Category" value="<?php if(!empty($id)) echo $pro['product_name']; else echo '';?>">
														</div>
													</div>
													</div>
													...
													<div class="col-sm-12">
														<div class="input-icon right">
															<span class="fa fa-user text-gray"></span>
															<input type="text" class="form-control" name="description" placeholder="Product Category Description" value="<?php if(!empty($id)) echo $pro['product_description']; else echo '';?>">
														</div>
													</div>
																	...
																	<div class="btn-group">
																		...
																		<ul role="menu" class="dropdown-menu pull-right">
																			<li role="presentation">
																				<a role="menuitem" tabindex="-1" href="productcategory.php?pid=<?php echo $product['id']; ?>">
																					<i class="glyphicon glyphicon-pencil"></i>Edit Category
																				</a>
																			</li>
																			<li role="presentation">
																				<a role="menuitem" tabindex="-1" href="addproduct.php?pid=<?php echo $product['id']; ?>">
																					<i class="glyphicon glyphicon-pencil"></i>View Product
																				</a>
																			</li>
																		</ul>
																	</div>
